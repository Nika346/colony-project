...
void Weather::print() const {
    switch (weath) {
        case Weather_type::Clear: cout << "Ясная"; break;
        case Weather_type::Cloudy: cout << "Облачная"; break;
        case Weather_type::Weak_storm: cout << "Слабая пылевая буря"; break;
        case Weather_type::Strong_storm: cout << "Сильная пылевая буря"; break;
        case Weather_type::Extremely_cold: cout << "Экстремальный холод"; break;
        case Weather_type::Radioactive_outbreak: cout << "Радиационная вспышка"; break;
        case Weather_type::Meteor_shower: cout << "Метеоритный дождь"; break;
        case Weather_type::Calm: cout << "Спокойная"; break;
    }
}
