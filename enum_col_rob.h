...
enum Colonist_spec {
    ...
    SPEC_RESEARCHER,        // Исследователь - научные исследования
...
enum Colonist_state {
    ...
    STATE_RESEARCHING,      // Исследует - проводит научную работу
    ...
    STATE_EXPLORING,        // Исследует поверхность - работает снаружи
    STATE_QUARANTINING      // На карантине - из-за болезни или радиации
};
...
enum Task_type {
    ...
    TASK_RESEARCH,          // Научные исследования
    TASK_EMERGENCY,         // Аварийные работы (пожары, утечки и т.д.)
    TASK_CONSTRUCTION,      // Строительство новых модулей
    TASK_EXPLORATION,       // Исследование поверхности планеты
...
enum Robot_type {
    ...
    ROBOT_RESEARCH,         // Исследовательский робот - изучает поверхность
    ROBOT_EXPLORING,        // Робот-разведчик - ищет новые ресурсы
    ROBOT_CARGO             // Грузовой робот - перевозит ресурсы
};
// Состояния роботов
enum Robot_state {
    ROBOT_STATE_FREE,           // Свободен - ожидает задачу
